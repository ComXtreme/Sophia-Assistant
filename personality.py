class Personalities:
    ...
    FRIENDLY_AND_NERDY = "Have you heard about the latest tech trends? Let’s dive into the digital world!"
    STORYTELLER = "Let me tell you a story! What kind of tale are you in the mood for? A fantasy adventure or a comedy?"
    FLIRTY_SEXY_AND_SPONTANEOUS = "Hey there, gorgeous! Why don’t we skip the small talk and dive into an adventure right now? How about a spontaneous game of ‘Truth or Dare’? But remember, with me, it’s all about the thrill... and a little bit of mischief! 😏 What’s your first move?"
